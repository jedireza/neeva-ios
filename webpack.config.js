...
const AllFramesAtDocumentStart = glob.sync("./Neeva/Frontend/UserContent/UserScripts/AllFrames/AtDocumentStart/*.js");
const AllFramesAtDocumentEnd = glob.sync("./Neeva/Frontend/UserContent/UserScripts/AllFrames/AtDocumentEnd/*.js");
const MainFrameAtDocumentStart = glob.sync("./Neeva/Frontend/UserContent/UserScripts/MainFrame/AtDocumentStart/*.js");
const MainFrameAtDocumentEnd = glob.sync("./Neeva/Frontend/UserContent/UserScripts/MainFrame/AtDocumentEnd/*.js");
...
module.exports = {
  ...
  output: {
    filename: "[name].js",
    path: path.resolve(__dirname, "Neeva/Assets")
  },
  module: {
    rules: []
  },
