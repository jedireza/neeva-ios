    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if let browserViewController = bottomViewController as? BrowserViewController {
            animateWithBackForward(
                backForwardViewController, browserViewController: browserViewController,
    ...
    fileprivate func animateWithBackForward(
        ...
        if presenting {
            ...
            UIView.animate(
                ...
                usingSpringWithDamping: 0.8, initialSpringVelocity: 0.3, options: [],
                animations: { () -> Void in
            ...
            UIView.animate(
                withDuration: transitionDuration(using: transitionContext), delay: 0,
                usingSpringWithDamping: 1.2, initialSpringVelocity: 0.0, options: [],
                animations: { () -> Void in
                    backForward.view.alpha = 0
                    backForward.tableView.snp.updateConstraints { make in
