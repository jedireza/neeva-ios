...
class UpdateCoverSheetViewModelTests: XCTestCase {
    ...
    func testShouldNotShowCoverSheetCleanInstall() {
        ...
        let shouldShow = UpdateViewModel.shouldShowUpdateSheet(
            currentAppVersion: currentTestAppVersion, isCleanInstall: true,
            supportedAppVersions: ["18"])
    ...
    func testShouldNotShowCoverSheetForSameVersion() {
        ...
        let shouldShow = UpdateViewModel.shouldShowUpdateSheet(
            currentAppVersion: currentTestAppVersion, isCleanInstall: false,
            supportedAppVersions: ["18"])
    ...
    func testShouldShowCoverSheetFromNoFeatureToUpdate() {
        ...
        let shouldShow = UpdateViewModel.shouldShowUpdateSheet(
            currentAppVersion: updatedTestAppVersion, isCleanInstall: false,
            supportedAppVersions: ["18"])
