        ...
        didSet {
            ...
            for suggestion in suggestions {
                ...
                if container.subviews.isEmpty {
                    ...
                    let image = UIImage.templateImageNamed("search")?.createScaled(CGSize(width: size, height: size)).tinted(withColor: UIColor.theme.homePanel.searchSuggestionPillForeground)
...
fileprivate class SuggestionButton: InsetButton {
    ...
    override var isHighlighted: Bool {
        didSet {
            backgroundColor = isHighlighted ? UIColor.theme.general.highlightBlue : UIColor.white
        }
    }
}
