...
class HomePageSettingViewController: SettingsTableViewController {
    ...
    override func generateSettings() -> [SettingSection] {
        ...
        let showNeevaHome = CheckmarkSetting(title: NSAttributedString(string: Strings.SettingsNewTabNeevaHome), subtitle: nil, accessibilityIdentifier: "HomeAsNeevaHome", isChecked: {return self.currentChoice == NewTabPage.homePage}, onChecked: {
