...
class ReaderModeStyleViewController: UIViewController {
    ...
    @objc func changeFontType(_ button: FontTypeButton) {
        ...
        delegate?.readerModeStyleViewController(
            self,
...
class FontTypeButton: UIButton {
    ...
    convenience init(fontType: ReaderModeFontType) {
        ...
        case .sansSerif,
            ...
            let f = UIFont(
                name: "FiraSans-Book", size: DynamicFontHelper.defaultHelper.ReaderStandardFontSize)
            titleLabel?.font = f
        case .serif,
            .serifBold:
...
class FontSizeButton: UIButton {
    ...
    convenience init(fontSizeAction: FontSizeAction) {
        ...
        titleLabel?.font = UIFont(
            name: "FiraSans-Light", size: DynamicFontHelper.defaultHelper.ReaderBigFontSize)
    }
}
    ...
    var fontType: ReaderModeFontType = .sansSerif {
        didSet {
            ...
            case .sansSerif,
                .sansSerifBold:
                font = UIFont(
                    name: "FiraSans-Book", size: DynamicFontHelper.defaultHelper.ReaderBigFontSize)
            case .serif,
                .serifBold:
                font = UIFont(
                    name: "NewYorkMedium-Regular",
