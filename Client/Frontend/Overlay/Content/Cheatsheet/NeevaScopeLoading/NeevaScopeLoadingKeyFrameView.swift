...
//        scale(to: frame.size)
    ...
    private func createGlare() {
        ...
        if let path = CGPathCreateWithSVGString("M0.779,7.319c-0.814,-0.509,-1.023,-1.51,-0.469,-2.249 4.053,-5.303,12.117,-6.664,18.037,-3.045 0.686,0.544,0.813,1.462,0.296,2.141 -0.516,0.679,-1.515,0.906,-2.328,0.529 -2.052,-1.264,-4.58,-1.744,-7.026,-1.333 -2.446,0.411,-4.61,1.678,-6.015,3.523 -0.561,0.731,-1.67,0.924,-2.495,0.435l0,0 0,0zM0.779,7.319") {
    ...
    private func createBody() {
        ...
        if let path = CGPathCreateWithSVGString("M17.035,9.818l19.465,-9.067 -14.415,45.008c-0.424,1.439,-2.017,2.171,-3.247,2.171 -1.23,0,-2.878,-0.848,-3.413,-2.57l-15.425,-45.36 17.035,9.818 0,0zM17.035,9.818") {
    ...
    private func createBand() {
        ...
        if let path = CGPathCreateWithSVGString("M19.267,32.57c-3.348,-0.434,-6.648,-1.643,-9.626,-3.679 -6.607,-4.516,-9.996,-11.98,-9.611,-19.426l6.471,-9.464 0.239,1.863c-4.538,7.935,-2.287,18.155,5.389,23.405l0,-0.011c3.848,2.635,8.578,3.645,13.164,2.815l2.708,1.425 -8.733,3.072 0,0zM19.267,32.57") {
