...
public class Timeline_1: Timeline {
    public convenience init(view: Stage1View, duration: TimeInterval, autoreverses: Bool = false, repeatCount: Float = 0) {
        let animationsByLayer = Timeline_1.animationsByLayer(view: view, duration: duration)
        self.init(view: view, animationsByLayer: animationsByLayer, sounds: [], duration: duration, autoreverses: autoreverses, repeatCount: repeatCount)
    }
    private static func animationsByLayer(view: Stage1View, duration: TimeInterval) -> [CALayer: [CAKeyframeAnimation]] {
        ...
        animationsByLayer[view.scope.layer] = [position_y_scope, transform_rotation_z_scope, bounds_size_width_scope, position_x_scope]
        animationsByLayer[view.glare.layer] = [transform_rotation_z_glare, bounds_size_width_glare, path_glare, bounds_size_height_glare, position_x_glare, position_y_glare]
