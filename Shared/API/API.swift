...
public struct AddSpaceResultInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap
  ...
  ///   - richContent
  ///   - comment
  public init(spaceId: String, resultId: String, url: Swift.Optional<String?> = nil, title: Swift.Optional<String?> = nil, snippet: Swift.Optional<String?> = nil, requestId: String, resultType: String, contentType: Swift.Optional<String?> = nil, contentUrl: Swift.Optional<String?> = nil, contentHeight: Swift.Optional<Int?> = nil, contentWidth: Swift.Optional<Int?> = nil, richContent: Swift.Optional<TabularRichContentInput?> = nil, comment: Swift.Optional<String?> = nil) {
    graphQLMap = ["spaceID": spaceId, "resultID": resultId, "url": url, "title": title, "snippet": snippet, "requestID": requestId, "resultType": resultType, "contentType": contentType, "contentURL": contentUrl, "contentHeight": contentHeight, "contentWidth": contentWidth, "richContent": richContent, "comment": comment]
  }
  ...
  public var resultId: String {
    get {
      return graphQLMap["resultID"] as! String
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "resultID")
    }
  ...
  public var requestId: String {
    get {
      return graphQLMap["requestID"] as! String
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "requestID")
    }
  ...
  public var resultType: String {
    get {
      return graphQLMap["resultType"] as! String
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "resultType")
    }
  }
  ...
  public var contentUrl: Swift.Optional<String?> {
    get {
      return graphQLMap["contentURL"] as? Swift.Optional<String?> ?? Swift.Optional<String?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "contentURL")
    }
  }

  public var contentHeight: Swift.Optional<Int?> {
    get {
      return graphQLMap["contentHeight"] as? Swift.Optional<Int?> ?? Swift.Optional<Int?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "contentHeight")
    }
  }

  public var contentWidth: Swift.Optional<Int?> {
    get {
      return graphQLMap["contentWidth"] as? Swift.Optional<Int?> ?? Swift.Optional<Int?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "contentWidth")
    }
  }

  public var richContent: Swift.Optional<TabularRichContentInput?> {
    get {
      return graphQLMap["richContent"] as? Swift.Optional<TabularRichContentInput?> ?? Swift.Optional<TabularRichContentInput?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "richContent")
    }
  }
...
public struct TabularRichContentInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap
  ...
  ///   - schemaVersion
  ///   - rows
  public init(contentType: Swift.Optional<String?> = nil, schemaVersion: Swift.Optional<Int?> = nil, rows: Swift.Optional<[RichContentListDataInput]?> = nil) {
    graphQLMap = ["contentType": contentType, "schemaVersion": schemaVersion, "rows": rows]
  }
  ...
  public var schemaVersion: Swift.Optional<Int?> {
    get {
      return graphQLMap["schemaVersion"] as? Swift.Optional<Int?> ?? Swift.Optional<Int?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "schemaVersion")
    }
  }

  public var rows: Swift.Optional<[RichContentListDataInput]?> {
    get {
      return graphQLMap["rows"] as? Swift.Optional<[RichContentListDataInput]?> ?? Swift.Optional<[RichContentListDataInput]?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "rows")
    }
  }
}

public struct RichContentListDataInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap

  /// - Parameters:
  ///   - items
  public init(items: Swift.Optional<[RichContentListItemInput]?> = nil) {
    graphQLMap = ["items": items]
  }

  public var items: Swift.Optional<[RichContentListItemInput]?> {
    get {
      return graphQLMap["items"] as? Swift.Optional<[RichContentListItemInput]?> ?? Swift.Optional<[RichContentListItemInput]?>.none
    }
    set {
...
public struct RichContentListItemInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap

  /// - Parameters:
  ///   - sections
  public init(sections: Swift.Optional<[RichContentSectionInput]?> = nil) {
    graphQLMap = ["sections": sections]
  }

  public var sections: Swift.Optional<[RichContentSectionInput]?> {
    get {
      return graphQLMap["sections"] as? Swift.Optional<[RichContentSectionInput]?> ?? Swift.Optional<[RichContentSectionInput]?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "sections")
    }
  }
}

public struct RichContentSectionInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap

  /// - Parameters:
  ///   - title
  ///   - items
  public init(title: Swift.Optional<String?> = nil, items: Swift.Optional<[RichContentSectionItemInput]?> = nil) {
    graphQLMap = ["title": title, "items": items]
  }
  ...
  public var items: Swift.Optional<[RichContentSectionItemInput]?> {
    get {
      return graphQLMap["items"] as? Swift.Optional<[RichContentSectionItemInput]?> ?? Swift.Optional<[RichContentSectionItemInput]?>.none
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "items")
    }
...
public struct RichContentSectionItemInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap
  ...
  ///   - url
  ///   - image
  public init(type: Swift.Optional<String?> = nil, text: Swift.Optional<String?> = nil, url: Swift.Optional<String?> = nil, image: Swift.Optional<RichContentSectionImageItemInput?> = nil) {
    graphQLMap = ["type": type, "text": text, "url": url, "image": image]
  }
  ...
  public var image: Swift.Optional<RichContentSectionImageItemInput?> {
    get {
      return graphQLMap["image"] as? Swift.Optional<RichContentSectionImageItemInput?> ?? Swift.Optional<RichContentSectionImageItemInput?>.none
    }
    set {
...
public struct RichContentSectionImageItemInput: GraphQLMapConvertible {
  ...
  /// - Parameters:
  ///   - url
  public init(url: Swift.Optional<String?> = nil) {
    graphQLMap = ["url": url]
  }
...
public final class AddSpaceResultMutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    mutation AddSpaceResult($input: AddSpaceResultInput!) {
      addSpaceResult(input: $input)
    }
    """

  public let operationName: String = "AddSpaceResult"

  public let operationIdentifier: String? = "d39a64b90e3a9f59e2572754e0146717e39df4ea5ca2c6a0dd77b22844227db0"

  public var input: AddSpaceResultInput

  public init(input: AddSpaceResultInput) {
    self.input = input
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("addSpaceResult", arguments: ["input": GraphQLVariable("input")], type: .nonNull(.scalar(String.self))),
      ]
    }
    ...
    public init(addSpaceResult: String) {
      self.init(unsafeResultMap: ["__typename": "Mutation", "addSpaceResult": addSpaceResult])
    }

    /// Add a search result to a space, and return the ID of the space result.
    public var addSpaceResult: String {
      get {
        return resultMap["addSpaceResult"]! as! String
      }
      set {
        resultMap.updateValue(newValue, forKey: "addSpaceResult")
      }
    }
  }
}
