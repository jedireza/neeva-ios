...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/piknotech/SFSafeSymbols", .upToNextMajor(from: "2.1.3"))
    ],
    targets: [
        ...
        .target(
            name: "NeevaSupport",
            dependencies: ["Apollo", "KeychainAccess", "RemoteImage", "Defaults", "Introspect", "Reachability", "SFSafeSymbols"],
